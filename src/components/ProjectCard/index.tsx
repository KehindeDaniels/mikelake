  ...
  return (
    ...
    >
      ...
      <div className="p-5">
        {/* Category tag */}
        <div className="mb-2">
          <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium capitalize bg-blue-600/10 text-blue-700 dark:text-blue-300 dark:bg-blue-500/10">
            {category}
          </span>
        </div>
