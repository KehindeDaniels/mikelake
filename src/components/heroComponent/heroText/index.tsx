...
const HeroText: React.FC = () => {
  return (
    ...
    text-center text-4xl leading-[80px] font-medium text-[#ECECEC]
    mb-6 sm:mb-2 max-sm:text-3xl max-sm:leading-snug sm:text-4xl sm:leading-[1.2] md:text-5xl md:leading-[1.2]`}
        >
        ...
        {/* Supporting text — Lato (via var), or swap to your site default */}
        <p
          className={`${lato.className} 
    text-center text-[20px] leading-[32px] text-white/80 
    mb-10 max-w-xl sm:max-w-3xl mx-auto max-sm:text-base max-sm:leading-6`}
        >
