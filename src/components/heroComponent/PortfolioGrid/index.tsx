    ...
    <section>
      <div className="relative max-w-[75rem] mx-auto px-4">
        ...
        >
          ...
          {/* Fade edges */}
          <div className="pointer-events-none absolute inset-y-0 left-0 w-32 bg-gradient-to-r from-slate-900/70 via-slate-900/30 to-transparent z-10"></div>
          <div className="pointer-events-none absolute inset-y-0 right-0 w-32 bg-gradient-to-l from-slate-900/70 via-slate-900/30 to-transparent z-10"></div>
